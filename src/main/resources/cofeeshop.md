## Пример Cofeeshop (Обработка ошибок в системе акторов)
...
import ru.steklopod.cofeeshop.Order.{CappuccinoRequest, EspressoRequest}
...
class Barista extends Actor {
  def receive = {
    case CappuccinoRequest => println("Я должен приготовить капучино!")
