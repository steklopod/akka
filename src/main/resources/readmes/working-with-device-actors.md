...
До сих пор мы начали разработку нашей общей архитектуры, и мы написали первого актора, который непосредственно соответствует 
домену. Теперь нам нужно создать компонент, который отвечает за поддержку групп устройств и самих самих устройств.
